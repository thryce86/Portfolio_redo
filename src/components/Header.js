...
class Header extends Component {
  ...
  render() {
    ...
    return (
      <header id="home" style={{ height: window.innerHeight - 100, display: 'block' }} title="Awesome person interested in software development" >
        <p> Awesome person interested in software development   </p>
